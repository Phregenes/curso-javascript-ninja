...
var operation = justMod2Or3.reduce( function(acumulator, item){
...
var name = [ 'pe', 'dro'];
var reduceP = name.reduce(function (acumulator, item){
  return acumulator + 'P' + item;
}, '');
console.log("reduceP", reduceP);
...
console.log("inversed", inversedName)
